...
class GamingCommandsLoader(AzCommandsLoader):
    def __init__(self, cli_ctx=None):
        ...
        gaming_custom = CliCommandType(operations_tmpl="azext_gaming.custom#{}", client_factory=cf_gaming)
        super(GamingCommandsLoader, self).__init__(cli_ctx=cli_ctx, custom_command_type=gaming_custom)
